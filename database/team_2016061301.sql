...
--
-- Host: localhost
-- Generation Time: 2016-06-13 14:47:01
-- 服务器版本： 5.7.7-rc
-- PHP Version: 5.6.10
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='文件表';

--
-- 转存表中的数据 `file`
--

INSERT INTO `file` (`id`, `folder_id`, `name`, `path`, `size`, `time`, `modify_time`) VALUES
(5, 1, 'error.log', 'upload_bade484a37a1857adeb458b0fbf2b9a2.log', 14192, 1465829146, 1465829146);
...
INSERT INTO `folder` (`id`, `user_id`, `name`, `time`, `modify_time`) VALUES
(1, 19, '我的文件夹', 1465806727, 0),
(2, 19, '小木', 1465806796, 0),
(7, 20, '设计图', 1465812687, 0),
(8, 20, '参考资料', 1465812858, 0),
(9, 20, '需求文档', 1465813319, 0);
